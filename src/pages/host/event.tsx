...
const CompetitiveAdvantage: FeatureItem[] = [
  ...
  },
  {
    ...
    description: (
      <>
        영어 상담 및 문서 발급 지원 등<br />
        외국인 게스트를 위한
        <br />
        최적의 서비스로 편리한 호스팅을 지원합니다.
      </>
    ),
  ...
  return (
    <div style={{ backgroundColor: "black" }}>
        ...
        <div className={styles.centerContainer}>
          <div className={styles.textContainer}>
            ...
            <p className={styles.subtitle}>
              외국인 게스트와 함께, 공실 걱정 없는 안정적인 수익을 잡으세요.
            </p>
            <div className="container">
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSffXoKk7xgAOh3ZxFwMyWCjEZmSIv2AHDqgcm1XuueZiQU6QA/viewform">
                <button
      ...
      <section className={styles.rowContainer}>
        ...
        <p>Enkostay는 호스트로부터 수수료를 받지 않습니다.</p>
        <h3>호스트가 되기 위한 별도의 조건이 있나요?</h3>
        <p>
          별도의 사업자 등록 및 서류 제출없이 누구나 단기 임대가 가능합니다.
        </p>
        <h3>Enkostay는 어떤 서비스 인가요?</h3>
        <p>
          Enkostay는 외국인들이 쉽게 예약 가능한 단기임대 주거플랫폼입니다.
          <br />
          호스트(임대인)은 간편하게 방 정보를 등록하고, 게스트(임차인)은 매물을
          보고 임대 및 예약 문의를 통해 호스트와 직접 소통하게 됩니다.
        </p>
        <h3>세입자도 호스트가 될 수 있나요?</h3>
        <p>
          물론이죠! 다만 사전에 실제 소유자에게 전대 동의를 받으셔야 합니다.
        </p>
        <h3>호스트 등록에 도움을 받을 수 있나요?</h3>
        <p>
          물론이죠! 요청해주신다면, 담당자가 직접 숙소 등록을 도와드리고
          있습니다.
        </p>
        ...
        <p>
          게스트가 예약 및 결제를 완료하면 호스트에게 예약 요청이 갑니다.
          호스트는 지점 운영 상황에 따라 예약을 승인 또는 거절 (보통 24시간 이내
          답변) 할 수 있습니다. 예약 승인시 결제 대금이 정상 승인되며 예약
          거절시 결제 대금은 환불됩니다.
        </p>
        <h3>숙소가 잘 등록되었는지 잘 모르겠어요.</h3>
        <p>
          숙소 등록을 한 후에도 Enkostay에서 지속적인 관리가 되며, 무료 컨설팅을
          통해 더욱 효과적인 호스팅을 진행할 수 있습니다.
        </p>
      </section>
      <section>
