...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Cheaper and easier stays in Korea. No deposit. Residence Card documents
  ...
  },
  {
    ...
    description: (
      <>
        Residence Card application processing trusted by institutions in Korea.
        Easy and reliable with English customer support.
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        Hassle-free bedding rental delivered to your dorm. Routine washing
        provided.
      </>
    ),
