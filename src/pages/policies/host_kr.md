...
이 약관은 엔코위더스(이하 ‘회사’)가 제공하는 ‘enkorstay’(https://stay.enko.kr/) 와 호스트 웹페이지(https://host.enko.kr/) 서비스 (이하 ‘서비스’)의 사용과 관련하여 ‘회사’와 ‘호스트’간의 권리와 의무 및 기타 필요한 사항을 규정함을 목적으로 한다.
